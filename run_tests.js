...
const child=require('child_process');	
		let start=`${__dirname}/node_modules/.bin/webdriver-manager update && ${__dirname}/node_modules/.bin/webdriver-manager start --seleniumPort 4445 --detach`;
		...
		const proc=child.exec(start+' && '+run_tests).stdout.pipe(process.stdout);	
